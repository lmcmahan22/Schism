...
namespace Schism.ViewModels
{
    public class ConnSettingsViewModel : BindableBase, IDialogAware
    {
        ...
        private string _selectedAddressConvention; // Default selection
        ...
        {
            get => _ipAddress;
            set { SetProperty(ref _ipAddress, value); OnPropertyChanged(); }
        }

        public string TCPPort
        {
            get => _tcpPort;
            set { SetProperty(ref _tcpPort, value); OnPropertyChanged(); }
}

        public int ScanRate
        {
            get => _scanRate;
            set { SetProperty(ref _scanRate, value); OnPropertyChanged(); }
        }

        public int Timeout
        {
            get => _timeout;
            set { SetProperty(ref _timeout, value); OnPropertyChanged(); }
        }

        public int PollDelay
        {
            get => _pollDelay;
            set { SetProperty(ref _pollDelay, value); OnPropertyChanged(); }
        }
        ...
        public string SelectedAddressConvention
        {
            ...
            set { SetProperty(ref _selectedAddressConvention, value); OnPropertyChanged(); }
        }
