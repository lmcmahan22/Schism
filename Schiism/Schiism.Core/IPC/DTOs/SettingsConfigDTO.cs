...
namespace Schiism.Core.IPC.DTOs
{
    ...
    /// </summary>
    public record SettingsConfigDTO
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SettingsConfigDTO"/> class.
        /// </summary>
        ...
        [JsonConstructor]
        public SettingsConfigDTO(string? iPAddress, ushort? dataLength, ushort? startAddress, ushort? tCPPort, int? scanRate, int? tCPTimeout, byte? deviceId, DataSize? selectedDataSize, PollType? selectedPollType, bool? asciiEnable, NumericBase? selectedNumericBase, Endian? selectedEndian, bool? autoStart, bool? autoRestart)
        {
            IPAddress = iPAddress;
