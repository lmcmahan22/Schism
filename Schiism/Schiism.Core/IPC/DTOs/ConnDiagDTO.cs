...
namespace Schiism.Core.IPC.DTOs
{
    ...
    /// </summary>
    public record ConnDiagDTO
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConnDiagDTO"/> class. Note that the parameters must match the record properties for JSON deserialization to work correctly (case-insenstitive).
        /// </summary>
        ...
        [JsonConstructor]
        public ConnDiagDTO(int numRequests, int numResponses, int numOKs, int numErrors, string errorMessage, bool isConnected, DateTime timestamp)
        {
