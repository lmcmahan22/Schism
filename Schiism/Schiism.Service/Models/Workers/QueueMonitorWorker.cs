        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            try
            {
                while (await timer.WaitForNextTickAsync(stoppingToken))
                {
                    ...
                    logger.LogInformation("Timestamp={Timestamp} Now={Now}", m.LastEnqueueTime, DateTime.UtcNow);
                    ...
                    logger.LogInformation("Timestamp={Timestamp} Now={Now}", c.LastEnqueueTime, DateTime.UtcNow);
