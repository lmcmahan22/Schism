...
namespace Schiism.WPF.ViewModels.Tabs
{
    public class RegisterPollSettingsViewModel : PollSettingsViewModel
    {
        ...
        public RegisterPollSettingsViewModel(string header, PollType polltype, ConfigState modbusSettState, SelectedAddressConvention selConv, ThemesControl themeController)
            : base(header, polltype, modbusSettState, selConv, themeController)
        {
            ModbusSettState.PropertyChanged += ModbusSettChanged;
        }
